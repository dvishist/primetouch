		...
		<section className="py-16 bg-linear-to-b from-white to-gray-50">
			<Container size="md">
				...
				>
					...
					>
						<Text c="dimmed" size="sm" mt={4}>
							Our professional team arrives on time with all supplies and equipment. Sit back while
					...
					<Timeline.Item
						...
						title={
							<Text fw={600} size="lg">
								5. Enjoy Your Spotless Space
							</Text>
						}
					>
						<Text c="dimmed" size="sm" mt={4}>
							Walk into a fresh, clean environment. Not satisfied? We'll make it right with our 100%
